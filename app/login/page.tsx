  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-950 px-4">
      <div className="w-full max-w-sm rounded-xl border border-neutral-800 bg-neutral-900 p-8 shadow-xl">
        ...
        <p className="mt-1 text-sm text-neutral-400">Admin sign in</p>
        ...
        <form action={loginAction} className="mt-6 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="admin@tradingschool.local"
            />
          </div>
          <div>
        ...
        <p className="mt-6 text-xs text-neutral-500">
          Demo credentials are in <code className="text-neutral-400">.env</code> (
          <code className="text-neutral-400">ADMIN_EMAIL</code> /{" "}
          <code className="text-neutral-400">ADMIN_SEED_PASSWORD</code>) after running the seed script.
        </p>
      </div>
    </div>
  );
